                            ...
                            <div class="live-preview">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control name" name="name"
                                        id="categoryInput" value="{{ old('name', $category->name) }}" placeholder="Nhập tên danh mục...">
                                    @error('name')
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <input type="radio" class="btn-check statusCategories" value="0" name="status"
                                        id="success-outlined" autocomplete="off" {{ old('status', $category->status) == 0 ? 'checked' : '' }}>
                                    ...
                                    <input type="radio" class="btn-check statusCategories" value="1" name="status"
                                        id="danger-outlined" autocomplete="off" {{ old('status', $category->status) == 1 ? 'checked' : '' }}>
                                    <label class="btn btn-outline-danger" for="danger-outlined">Ẩn</label>
                                </div>
                                <div class="col-12">
                                    <div class="text-start">
                                        <button type="submit" id="btnAddCate" name="insertCategory"
                                            class="btn btn-primary insertCategory">Cập nhật danh
                                            mục</button>
