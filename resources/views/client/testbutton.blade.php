...
<html lang="en" class="no-js">
	<head>
        ...
        <link rel="stylesheet" href="{{ asset('codrops/css/default.css') }}">
        <link rel="stylesheet" href="{{ asset('codrops/css/default.css') }}">
        <link rel="stylesheet" href="{{ asset('codrops/css/component.css') }}">
		...
		<div class="container">
			...
			<section class="color-1">
				...
				<p>
					...
					<button class="btn btn-1 btn-1c">Button</button>  //đây
