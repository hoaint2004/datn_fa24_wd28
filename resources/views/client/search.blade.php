...
@section('content')
    ...
    <section class="filter-product uk-container uk-container-large">
        <div class="filter-top uk-container uk-container-small">
            <h2 class="title-category">Kết quả tìm kiếm: {{ request()->keyword ?? '' }}</h2>
