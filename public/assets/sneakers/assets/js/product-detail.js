                    ...
                    const htmlComment = `
                        <div class="comment-parent" id="comment-parent-${response.data.comment.id}">
                            ...
                            <div class="media-comment-body">
                                ...
                                <div class="text-right">
                                    <a href="" class="btn-edit" data-id_comment="${response.data.comment.id}" data-content="${response.data.comment.content}">Sửa</a>
                                    <form action="${commentDestroy}" method="post" class="delete-comment">
                                        <button type="submit" class="btn-delete" data-comment_id="${response.data.comment.id}">Xóa</button>
                                    </form>
                                    <a class="btn-reply" href="" data-id_comment="${response.data.comment.id}">Trả lời</a>
                                </div>
                            </div>
                        </div>`;
