!function (t, e) {
    ...
    var f = function () {
        ...
        function e(e) {
            var i;
            return (i = t.call(this, "svg") || this)._container = e, i._defsElement = new f("defs"), i._rootElement = new f("g", {id: "jvm-regions-group"}), i.node.appendChild(i._defsElement.node), i.node.appendChild(i._rootElement.node), i._container.appendChild(i.node), i
        }
    ...
    function x(t, e, i) {
        var s = h(e), a = -1 === s.getAttribute("class").indexOf("jvm-region") ? "marker" : "region",
            n = "region" === a ? s.getAttribute("data-code") : s.getAttribute("data-index"), r = a + ":selected";
    ...
    var C = function (t) {
        ...
        return i.updateLabelPosition = function () {
            ...
            var e = t.index, i = t.map, s = t.label, a = t.labelsGroup, n = t.cx, r = t.cy, o = t.marker,
    ...
    var O = {
        mill: function (t, e, i) {
            ...
            var s = i * this.radDeg, a = 29.5 * this.radDeg, n = 45.5 * this.radDeg, r = t * this.radDeg,
                o = e * this.radDeg, h = (Math.sin(a) + Math.sin(n)) / 2,
                l = Math.cos(a) * Math.cos(a) + 2 * h * Math.sin(a), c = h * (o - s),
                u = Math.sqrt(l - 2 * h * Math.sin(r)) / h, p = Math.sqrt(l - 2 * h * Math.sin(0)) / h;
            return {x: u * Math.sin(c) * this.radius, y: -(p - u * Math.cos(c)) * this.radius}
        }, lcc: function (t, e, i) {
            var s = i * this.radDeg, a = e * this.radDeg, n = 33 * this.radDeg, r = 45 * this.radDeg,
                o = t * this.radDeg,
    ...
    var A = {
        handleContainerEvents: function () {
            ...
            this.params.draggable && (w.on(this.container, "mousemove", (function (n) {
                ...
                var s = i.container.getBoundingClientRect(), n = t.pageX - s.left - window.pageXOffset,
            ...
            var t = this, e = this, i = l("div", "jvm-zoom-btn jvm-zoomin", "&#43;", !0),
            ...
            var t, e, i, s, a, n, r, o = this, h = function (h) {
                ...
                if ("touchstart" == h.type && (r = 0), 1 == d.length) 1 == r && (u = o.transX, p = o.transY, o.transX -= (i - d[0].pageX) / o.scale, o.transY -= (s - d[0].pageY) / o.scale, o.tooltip.hide(), o.applyTransform(), u == o.transX && p == o.transY || h.preventDefault()), i = d[0].pageX, s = d[0].pageY; else if (2 == d.length) if (2 == r) c = Math.sqrt(Math.pow(d[0].pageX - d[1].pageX, 2) + Math.pow(d[0].pageY - d[1].pageY, 2)) / e, o.setScale(t * c, a, n), o.tooltip.hide(), h.preventDefault(); else {
            ...
            for (var o in this.linesGroup = this.linesGroup || this.canvas.createGroup("jvm-lines-group"), t) {
                ...
                !1 !== n && !1 !== r && (a = new _({
                    index: o,
                    map: this,
                    style: u({initial: this.params.lineStyle}, {initial: h.style || {}}, !0),
                    x1: n.x,
                    y1: n.y,
                    x2: r.x,
                    y2: r.y,
            ...
            for (var o in void 0 === t && (t = {}), void 0 === e && (e = !1), this.markersGroup = this.markersGroup || this.canvas.createGroup("jvm-markers-group"), this.markerLabelsGroup = this.markerLabelsGroup || this.canvas.createGroup("jvm-markers-labels-group"), t) {
                ...
                !1 !== a && (s = new C({
                    ...
                    marker: i,
                    isRecentlyCreated: e
                }), this.markers[o] && this.removeMarkers([o]), this.markers[o] = {_uid: n, config: i, element: s})
            }
        }, createSeries: function () {
            for (var t in this.series = {
                markers: [],
                regions: []
            }, this.params.series) for (var e = 0; e < this.params.series[t].length; e++) this.series[t][e] = new Y(this.params.series[t][e], this[t], this)
            ...
            if (t.coords) {
                var a = this.coordsToPoint(t.coords[0], t.coords[1]), n = this.transX - a.x / this.scale,
            ...
            var n, r, o, h, l, c, u, p, d, f, m = this, g = 0,
            ...
            w.on(this._map.container, "mousemove", (function (e) {
                if (t._tooltip.classList.contains("active")) {
                    var i, s,
                        ...
                        n = t._tooltip.getBoundingClientRect(), r = n.height, o = n.width,
                        h = e.clientY <= a.top + r + 5, l = e.pageY - r - 5, c = e.pageX - o - 5;
        ...
        return e.init = function (t) {
            ...
            var e = this;
            void 0 === t && (t = !0);
            var i = w.getEventRegistry(), s = Object.keys;
    ...
    }, Object.assign(D.prototype, A), function () {
        function t(t) {
